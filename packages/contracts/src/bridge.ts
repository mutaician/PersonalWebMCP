...
export const BRIDGE_MESSAGE_TYPES = [
  ...
  'NATIVE_TOOL_RESULT',
  'PERSONAL_TOOLS_SYNCED',
] as const;

export type BridgeCommandType = 'INITIALIZE' | 'REFRESH_CATALOG' | 'RUN_PING_SELF_TEST' | 'WITHDRAW_PING' | 'SYNC_PERSONAL_TOOLS' | 'PERSONAL_TOOL_RESULT' | 'EXECUTE_NATIVE_TOOL';
export type BridgeEventType = 'STATUS' | 'CATALOG' | 'PING_RESULT' | 'PERSONAL_TOOL_INVOCATION' | 'PERSONAL_TOOL_CANCEL' | 'NATIVE_TOOL_RESULT' | 'PERSONAL_TOOLS_SYNCED';
